...
export default function Services() {
  ...
  const services = [
    { title: "Web Development", description: "Custom websites and web applications using modern technologies." },
    { title: "Mobile Development", description: "Cross-platform mobile apps with React Native." },
    { title: "Backend Development", description: "Scalable backend solutions with Node.js and Express.js." },
    { title: "UI/UX Design", description: "User-centric design using Figma and best practices." },
    { title: "SEO Optimization", description: "Improve search engine ranking with SEO strategies." }
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <div className="container mx-auto py-16 px-6">
        <h1 className="text-4xl font-bold mb-6 text-center text-blue-600">My Services</h1>
