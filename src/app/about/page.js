      ...
      <div className="container mx-auto py-16 px-6">
        ...
        <div className="max-w-3xl mx-auto p-6 shadow-lg rounded-lg">
          ...
          <p className="text-lg text-gray-700 mb-4">
            Saya <strong>Panji Arif Maulana</strong>, seorang mahasiswa di <strong>Ma'soem University</strong>
            dengan program studi <strong>Sistem Informasi</strong>. Saat ini saya berada di <strong>semester 4</strong>
            dan sedang mendalami <strong>pemrograman mobile</strong> dalam mata kuliah <strong>Pemrograman Mobile 1</strong>.
          </p>
          ...
          <ul className="list-disc list-inside text-gray-700">
            ...
            <li>Web Development (HTML, CSS, React.js, Next.js, Tailwind CSS)</li>
          ...
          <p className="text-gray-700">
            Saya tertarik dalam pengembangan aplikasi mobile, baik Android maupun iOS, dengan teknologi terbaru.
            Tujuan saya adalah menjadi seorang <strong>Mobile Developer</strong> yang handal dan terus belajar untuk
            mengembangkan aplikasi berkualitas tinggi.
          </p>
          
          <h3 className="text-xl font-semibold mt-6 mb-2">Kontak</h3>
          <p className="text-gray-700">Jika ingin terhubung, silakan hubungi saya melalui:</p>
          <ul className="list-disc list-inside text-gray-700">
            <li>Email: <a href="mailto:panji@example.com" className="text-blue-500 hover:underline">panji@example.com</a></li>
            <li>LinkedIn: <a href="https://linkedin.com/in/panji" className="text-blue-500 hover:underline">linkedin.com/in/panji</a></li>
            <li>GitHub: <a href="https://github.com/panji" className="text-blue-500 hover:underline">github.com/panji</a></li>
          </ul>
        </div>
      </div>
    </div>
